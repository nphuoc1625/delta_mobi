...
export const ErrorCodes = {
    ...
    PRODUCT: {
        ...
        // Business Rule specific errors
        NAME_REQUIRED: 'PRODUCT_NAME_REQUIRED',
        NAME_TOO_SHORT: 'PRODUCT_NAME_TOO_SHORT',
        NAME_TOO_LONG: 'PRODUCT_NAME_TOO_LONG',
        NAME_DUPLICATE: 'PRODUCT_NAME_DUPLICATE',
        CATEGORY_REQUIRED: 'PRODUCT_CATEGORY_REQUIRED',
        CATEGORY_INVALID: 'PRODUCT_CATEGORY_INVALID',
        PRICE_REQUIRED: 'PRODUCT_PRICE_REQUIRED',
        PRICE_INVALID: 'PRODUCT_PRICE_INVALID',
        IMAGE_REQUIRED: 'PRODUCT_IMAGE_REQUIRED',
        IMAGE_INVALID: 'PRODUCT_IMAGE_INVALID',
        INDEPENDENCE_VIOLATION: 'PRODUCT_INDEPENDENCE_VIOLATION',
        RELATIONSHIP_VIOLATION: 'PRODUCT_RELATIONSHIP_VIOLATION',
...
export const ErrorMessages = {
    ...
    [ErrorCodes.PRODUCT.NAME_REQUIRED]: 'Product name is required',
    [ErrorCodes.PRODUCT.NAME_TOO_SHORT]: 'Product name must be at least 1 character',
    [ErrorCodes.PRODUCT.NAME_TOO_LONG]: 'Product name must be at most 200 characters',
    [ErrorCodes.PRODUCT.NAME_DUPLICATE]: 'Product name already exists',
    [ErrorCodes.PRODUCT.CATEGORY_REQUIRED]: 'Product category is required',
    [ErrorCodes.PRODUCT.CATEGORY_INVALID]: 'Invalid product category',
    [ErrorCodes.PRODUCT.PRICE_REQUIRED]: 'Product price is required',
    [ErrorCodes.PRODUCT.PRICE_INVALID]: 'Product price must be a positive number (≥ 0.01)',
    [ErrorCodes.PRODUCT.IMAGE_REQUIRED]: 'Product image is required',
    [ErrorCodes.PRODUCT.IMAGE_INVALID]: 'Invalid product image format',
    [ErrorCodes.PRODUCT.INDEPENDENCE_VIOLATION]: 'Product independence violation',
    [ErrorCodes.PRODUCT.RELATIONSHIP_VIOLATION]: 'Product relationship violation',
...
export const ErrorStatusCodes = {
    ...
    [ErrorCodes.PRODUCT.NAME_REQUIRED]: 400,
    [ErrorCodes.PRODUCT.NAME_TOO_SHORT]: 400,
    [ErrorCodes.PRODUCT.NAME_TOO_LONG]: 400,
    [ErrorCodes.PRODUCT.NAME_DUPLICATE]: 409,
    [ErrorCodes.PRODUCT.CATEGORY_REQUIRED]: 400,
    [ErrorCodes.PRODUCT.CATEGORY_INVALID]: 400,
    [ErrorCodes.PRODUCT.PRICE_REQUIRED]: 400,
    [ErrorCodes.PRODUCT.PRICE_INVALID]: 400,
    [ErrorCodes.PRODUCT.IMAGE_REQUIRED]: 400,
    [ErrorCodes.PRODUCT.IMAGE_INVALID]: 400,
    [ErrorCodes.PRODUCT.INDEPENDENCE_VIOLATION]: 400,
    [ErrorCodes.PRODUCT.RELATIONSHIP_VIOLATION]: 400,
